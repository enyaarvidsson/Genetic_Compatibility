...
# Save to csv-file
mobility_df.to_csv("/storage/enyaa/REVISED/mobility_classification_all.csv", index=False)
print("File 'mobility_classification_all.csv' created successfully!")
