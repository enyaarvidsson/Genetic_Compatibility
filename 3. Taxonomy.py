...
with open("/storage/enyaa/REVISED/BLAST/BLAST_RESULTS/blast_results_5.txt") as f: # opens the file for reading, stores in f
...
# Store results
store_results = "/storage/enyaa/REVISED/TAXONOMY/taxonomy_results_5.csv"
