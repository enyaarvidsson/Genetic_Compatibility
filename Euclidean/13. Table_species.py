...
mean_species_df.to_csv(f"/home/jolunds/newtest/table_species_{gene_name}.csv", index=False)
...
print(f"Table created for {gene_name} in {total_time} minutes for {num_species} species")
