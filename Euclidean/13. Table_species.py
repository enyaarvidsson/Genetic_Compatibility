...
gene_name = 'SHV-53'
euclidean_df = pd.read_pickle(f"/storage/enyaa/REVISED/KMER/euclidean_split_genes_filtered/euclidean_df_{gene_name}.pkl").reset_index(drop=True)
...
gene_matching_df = gene_taxonomy_df.merge(euclidean_df, on=['Bacteria_ID'], how="inner")
...
mean_species_df.to_csv(f"/home/jolunds/newtest/4. Table_species_filtered/table_species_{gene_name}.csv", index=False)
