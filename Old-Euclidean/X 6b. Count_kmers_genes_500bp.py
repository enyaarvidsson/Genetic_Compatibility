...
temp_directory = "/storage/enyaa/REVISED/KMER/FOR_GENE_LENGTH/gene_remove_temp" # used as kmc database & temporary directory
output_directory = "/storage/enyaa/REVISED/KMER/FOR_GENE_LENGTH/gene_kmer_500bp"
...
for record in tqdm(SeqIO.parse(fasta_file, "fasta"), desc="Processing genes"):
    ...
    gene_length = abs(end-start) # SKULLE INTE VA +1 HÄR !!!
    ...
    # KMC ---------------------------------
    # skapa temp fastafil och skicka till kmc
