...
path = f"/storage/jolunds/REVISED/TAXONOMY/new_taxonomy_split_genes/taxonomy_results_{gene_name}.csv" # this contains matches
...
num_to_remove = no_match_count - 2*match_count
