...
for gene_name in tqdm(gene_names_df["Gene_name"], desc="Processing genes"): 
    ...
    for bacteria_id in bacteria_ids:
        ...
        # tRNA score
        tRNA_total_score, tRNA_max_score, tRNA_max_codon = tRNA_score_one_sided(gene_dict, genome_dict)

        # Append results with additional information
        tRNA_score_list.append({
            "Bacteria_ID": bacteria_id,
            "tRNA_score_one_sided": tRNA_total_score,
    ...
    save_path = f"/storage/jolunds/REVISED/tRNA/tRNA_worst_case/tRNA_worst_case_{gene_name}.csv"
