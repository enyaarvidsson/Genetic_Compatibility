# This script includes four parts:
    # Calculating GC-content for the filtered bacteria, and storing it in a pkl file
    # Calculating GC-content for the genes, and storing it in a pkl file
    # Calculating the GC-ratio and making a scatterplot
    # Calculating the GC-ratio and making a scatterplot
...
# GC-content for the filtered bacteria
